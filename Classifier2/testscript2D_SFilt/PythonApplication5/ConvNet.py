...
f = open('../../../Data/properties.txt'); #properties contains the values for how many training/test levels are present.
...
f = open('../../../Data/TrainingData.txt', 'r') #The training data file is converted in this section
...
f = open('../../../Data/GoalData.txt', 'r') #The goal data file is converted from this point onwards
count = 0    
for line in f:
    if count%100 == 0:
        print(count)
...
f = open('../../../Data/SmallGoalData.txt', 'r') #For the results section, a smaller dataset is also created for small sized levels.
count = 0    
for line in f:
    if count%100 == 0:
        print(count)
...
f = open('../../../Data/LargeGoalData.txt', 'r')    #For the results section, a smaller dataset is also created for larger sized levels. 
count = 0    
for line in f:
    if count%100 == 0:
        print(count)
