...
if __name__ == "__main__":
    ...
    storage_location = os.environ['HOME']+"/storage/Classifier2/2D/Inception2/"
    ...
    for i in range(0,x):
        ...
        if (i%z == z-1 or i == x-1):
            shutil.copytree("/tmp/Classifier2/2D/Inception2", storage_location+str(y*(i+1)), ignore=None)
        else:
